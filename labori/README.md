...
### Aprakts
```
Darbā tika izveidota programma, kas sortē Char datu tipa locekļus,
pēc ASCII tabulas un atrisina ar virknēm saistitas darbibas.
Pats Bubble sort piemērs tika ņemts no https://www.geeksforgeeks.org/bubble-sort/ 
Darbā nesanāca izveidot grafiku, man neizprotamu problemu dēļ.
Izveidoju, lai dati tiktu pārsūtīti data.txt failu, 
bet nesanāca saprast, kādi ir pareizie dati,
kuri jāsūta uz data.txt failu un attēlošanas procesā, tika attēloti nepareizie dati.
```
### Grafiks
#### Tas tiek pievienots tikai, lai redzetu, ka izveidoju grafiku, kaut ari tiek attēlotas nepareizas vertibas.
![Grafiks](/labori/out.png)
